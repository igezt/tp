...
public class CommandTestUtil {
    ...
    public static void showPersonAtIndex(Model model, Index targetIndex) {
        ...
        PersonDescriptor descriptor = new EditPersonDescriptorBuilder().withName(name).build();
        model.updateFilteredPersonList(new PersonContainsKeywordsPredicate(descriptor));
